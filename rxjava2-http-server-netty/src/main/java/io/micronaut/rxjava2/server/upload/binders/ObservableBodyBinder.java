...
public class ObservableBodyBinder implements NonBlockingBodyArgumentBinder<Observable> {
     ...
     */
    public ObservableBodyBinder(BodyArgumentBinder<Publisher<Object>> publisherBodyBinder) {
    ...
    public BindingResult<Observable> bind(ArgumentConversionContext<Observable> context, HttpRequest<?> source) {
        ...
        Argument<Publisher<Object>> argument = new GenericArgument<>() {
            ...
            public Argument[] getTypeParameters() {
                return observableArgument.getTypeParameters();
            }

            @Override
            public Map<String, Argument<?>> getTypeVariables() {
                return observableArgument.getTypeVariables();
            }

            @Override
            public AnnotationMetadata getAnnotationMetadata() {
                return observableArgument.getAnnotationMetadata();
            }
        };
